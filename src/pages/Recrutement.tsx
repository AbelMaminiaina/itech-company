    ...
    <div className="pt-20">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1920&h=1080&fit=crop&q=80"
            alt="Rejoignez l'équipe iTech-Company - Carrière digitale"
            className="w-full h-full object-cover"
          />
          {/* Overlay pour améliorer la lisibilité */}
          <div className="absolute inset-0 bg-gradient-to-br from-dark-900/90 via-dark-900/85 to-blue-900/80 dark:from-dark-900/95 dark:via-dark-900/90 dark:to-blue-900/85"></div>
        </div>
